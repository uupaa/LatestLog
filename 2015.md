...
- Chrome 47 で、動作に余裕がある場合(低負荷状態)で関数をコールバックするメカニズム [requestIdleCallback](https://www.chromestatus.com/feature/5572795866021888) が実装されました
...
- Chrome 47 でマウスイベント発生時に同時に押していたキーを取得するメカニズム [MouseEvent.getModifierState](https://www.chromestatus.com/feature/5662574238498816) が実装されました
...
- Chrome 49 に [OfflineAudioContext#suspend() と OfflineAudioContext#resume()](https://www.chromestatus.com/feature/5294442458120192) が実装されました
    - [OfflineAudioContext IDL](https://chromium.googlesource.com/chromium/src/+/cdc0e15efab0e82a6e95deaae11a394535ea82de/third_party/WebKit/Source/modules/webaudio/OfflineAudioContext.idl)
...
- 2013-05 から検討を重ねていた CanvasProxy の検討が中断し、2015-12-01 から [OffscreenCanvas についての検討](https://wiki.whatwg.org/wiki/OffscreenCanvas)が始まっています
    ...
    - OffscreenCanvas は WebWorkers上においても完全に非同期に動作することが望まれています
    - この提案は、Safari, Chrome, IE, Firefox の実装者により吟味が行われており、APIの基本合意に至った場合は、広く互換性のある実装が行われる可能性があります
